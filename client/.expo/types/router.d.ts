...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/register` | `/register` | `/(tabs)/students` | `/students` | `/(tabs)/subjects` | `/subjects` | `/(tabs)/_layout` | `/_layout` | `/adds/addstudent` | `/adds/addsubject`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/edits/editstudent/${SingleRoutePart<T>}` | `/edits/editsubject/${SingleRoutePart<T>}` | `/enroll/${SingleRoutePart<T>}`;
  // prettier-ignore
  type DynamicRouteTemplate = `/edits/editstudent/[id]` | `/edits/editsubject/[id]` | `/enroll/[id]`;
